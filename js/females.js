...
function placeOrder1() {
  ...
  $("#appear").show();
  $(".haircut").text("You have selected the Short side that will cost you Ksh: " + price);
}
function placeOrder2() {
  price = parseInt(document.getElementById('overlay2').getAttribute('value'));

  $("#appear").show();
  $(".haircut").text("You have selected the Kinky Long hairstyle that will cost you Ksh: " + price);
}
...
function placeOrder8() {
  ...
  $("#appear").show();
  $(".haircut").text("You have selected the Short  Fade hairstyle that will cost you Ksh: " + price);
}
